...
school_admittance = "Harry Potter must not return to Hogwarts!"
p school_admittance
...
# first_name and is_hungry result in words, so they would be listed as Strings.
# number_of_pets is a whole number, so that can be listed as an integer.
